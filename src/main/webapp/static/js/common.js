...
/**
 * 模块名：共通脚本 程序名: 通用方法common.js Copyright(c) 2014-2015 qlan
 */
var bsc = {};
...
com.dialog = function(opts) {
	...
	/*
	 * if (query.isFunction(opts.html)) opts.html =
	 * utils.functionComment(opts.html); else if
	 * (/^\#.*\-template$/.test(opts.html)) opts.html = $(opts.html).html();
	 */
	...
	win.dialog(opts);
	/*
	 * query.parser.onComplete = function () { if ("undefined" === typeof ko)
	 * opts.viewModel(win); else ko.applyBindings(new opts.viewModel(win),
	 * win[0]);
	 * 
