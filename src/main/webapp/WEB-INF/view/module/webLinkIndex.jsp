...
<script type="text/javascript">
	jQuery(function(){	  
   	...
   	$('#dataTable').datagrid({
        ...
        remoteSort : false,
   		...
   		method : 'post',		
		idField : 'sortNo',//此处根据实际情况进行填写
		columns:[[
							{field:'sortNo',title:'排序号',width:40,align:"center"},
							{field:'dictName',title:'标题',width:80},
							{field:'dictTypeId',title:'类别',width:80},
							{field:'backup1',title:'创建时间',width:80},
							{  
								field : 'operate',
								title : '操作',
								width : 100,
   ...
   //表格查询
	function searchInfo() {
		...
		var url = '${rootPath}/sys/dictEntry/searchDictEntry?dictTypeId=weblink';
