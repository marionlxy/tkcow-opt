...
<body>
<div class="" title="发展历程模板·新增页面" style="width:1000px">
	<form id="dataForm" name="dataForm"
			...
			<div class="fitem">
		    	<label>排序号:</label>
		        <!-- <input name="weight" class="easyui-numberbox" data-options="required:true"> -->
...
function saveOrUpdate1() {
	...
	if (!r) {
		...
		$('#dataForm').form(
				'submit',
				{
					url : '${rootPath}/moduleDes/saveDevelopCourseElementInfo?pmodid=${parent_modid}',
					onSubmit : function() {
					...
					success : function(data) {
						...
						if (ajaxobj.result == 'true'
							...
							url = '/moduleDes/developCourseModuleIndex?backUp2='
							+ ajaxobj.backUp2;
