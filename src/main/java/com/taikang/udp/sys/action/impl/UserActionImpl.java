...
public class UserActionImpl extends BaseActionImpl 
  implements IUserAction {
	...
	public CurrentPage searchForPage(CurrentPage currentPage){
		logger.debug("<======UserAction--searchForPage======>");
		return userService.searchForPage(currentPage);
	}
	
	public CurrentPage querySysForPage(CurrentPage currentPage){
		logger.debug("<======UserAction--querySysForPage======>");
		return userService.querySysForPage(currentPage);
	}
}
