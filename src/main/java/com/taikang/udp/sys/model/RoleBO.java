...
public class RoleBO extends BaseBO {
	...
	protected void init() {
		super.init();
		this.addList(Arrays.asList("id", "addtime", "modifytime", "modifier", "deletestatus", "display", "info",
				"rolecode", "rolename", "sequence", "type", "rg_id"));
	}
	...
	public BigDecimal getRgId() {
		return (BigDecimal) getData().get("rg_id");
	}
