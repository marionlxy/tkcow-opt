 ...
 implements IUserService<UserBO>  
  {
	...
	public CurrentPage searchForPage(CurrentPage currentPage){
		logger.debug("<======UserServiceImpl--queryUserForPage======>");
		return appDao.queryForPage("User.searchUserForPage", currentPage);
	}
	
	public CurrentPage querySysForPage(CurrentPage currentPage){
		logger.debug("<======UserServiceImpl--querySysForPage======>");
		return appDao.queryForPage("User.querySysUserForPage", currentPage);
	}
 }
