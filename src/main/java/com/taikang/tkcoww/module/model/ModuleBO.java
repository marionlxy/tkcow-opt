package com.taikang.tkcoww.module.model;
...
public class ModuleBO  extends BaseBO {
	...
	protected void init(){
		super.init();
		this.addList(Arrays.asList("mod_id","mod_name","mod_parent_id","mod_isleaf","mod_level","mod_squence","mod_child_id","mod_url","created_time","created_by","modified_time","modified_by","version","delflag","mod_byname","mod_seo","title","seo_des","mod_des","mod_banner","mod_type","mod_img","mod_ico","mod_isdes","mod_key_world"));
	}
