 ...
 implements IOrderVisitService<OrderVisitBO>  
  {
	...
	public List<Dto> getvisitList(Dto param) {
		logger.debug("<======OrderVisitServiceImpl--getvisitList======>");		
		return appDao.queryForMapList("OrderVisit.getvisitList", param);
	}

	@Override
	public List findAllT(Dto dtoDate) {
		logger.debug("<======OrderVisitServiceImpl--findAllMapOrderVisit======>");		
		return appDao.queryForMapList("OrderVisit.findAllT", dtoDate);
	}
 }
