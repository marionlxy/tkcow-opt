...
<div fit="true" style="margin-top: 10px; margin-left: 10px;">
	<form id="dataFormLogo" enctype="multipart/form-data" method="post">
			...
			<div class="fitem">
		    	<label>描述:</label>
		        <textarea id="cooperLogoDes" rows=5 name="cooperLogoDes" class="easyui-validatebox " validType="length[0,2000]" style="width: 400px;">${data.cooperLogoDes}</textarea>
			</div>
			<div class="fitem">
		    	<label>Logo图:</label>
		        <input class="easyui-validatebox" validType="img_upload" name="logoFile" id="logoFile" type="file" onchange="javascript:setImagePreview();" accept=".jpg,.gif,.ico,.png, bmp">
			</div>
