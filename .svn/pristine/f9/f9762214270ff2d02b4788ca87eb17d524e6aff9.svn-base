...
<body class="easyui-layout">
						...
						$('#' + ${menu.menuId}).tree({
						    ...
						    onSelect:function(node) {
						    	if (node.checkUrl != null && node.checkUrl!="" && node.checkUrl!="null") {
						    		var title = wrapper.getCurrentTabTitle();
						    		if(title==node.menuName){
						    			wrapper.colseExistTitle(title);
						    		}
    ...
    <div region="south" border="false" id="south"><center>Copyright © 2016 All Rights Reserved</center></div>
